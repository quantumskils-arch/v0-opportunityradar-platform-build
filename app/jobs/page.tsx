...
export const metadata: Metadata = {
  ...
  description: 'Find the latest NGO and development sector jobs across East Africa. UNHCR, UNICEF, World Bank, and more. Updated daily.',
  keywords: ['NGO jobs Uganda', 'UN jobs Kenya', 'development jobs East Africa', 'humanitarian jobs', 'UNHCR careers'],
}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-white/70">
                  Careers in international development across East Africa
                </p>
              </div>
            </div>
      ...
      <section className="bg-navy py-12">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-white/70">
            Get the latest NGO jobs delivered to your inbox daily.
          </p>
          <div className="mt-6">
            <EmailSignup />
          </div>

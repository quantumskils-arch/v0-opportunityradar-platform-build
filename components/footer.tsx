...
const footerLinks = {
  opportunities: [
    ...
    { href: '/grants', label: 'Grants & Scholarships' },
  ],
  tools: [
...
export function Footer() {
  return (
    <footer className="bg-navy text-white">
      {/* AdSense placeholder */}
      <div id="adsense-footer" className="border-b border-white/10 py-4">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-white/60">
              East Africa&apos;s leading opportunity intelligence platform. Tenders, jobs, grants and scholarships delivered daily.
            </p>
            <div className="mt-6 flex gap-4">
              ...
              <a
                href="https://twitter.com/opportunityradar"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 transition-colors hover:text-accent-green"
                aria-label="Twitter"
              ...
              <a
                href="https://linkedin.com/company/opportunityradar"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 transition-colors hover:text-accent-green"
                aria-label="LinkedIn"
